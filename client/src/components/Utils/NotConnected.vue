    ...
    <nav class="navbar navbar-expand-sm fixed-top bg-success">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <div class="container-fluid">
            <div class="row">
              <button class="btn bg-success btn-link text-light border-0 col-6 col-md-2 col-lg-1 disabled">Playlists</button>
              <button class="btn bg-success btn-link text-light border-0 col-6 col-md-2 col-lg-1 disabled">Musics</button>
            </div>
          </div>
          <div class="d-flex btn-group btn-group-sm placeholder-wave" role="group">
            <button class="btn btn-light text-success disabled placeholder" type="button"><i class="fas fa-angle-double-left"></i></button>&nbsp;
            <button class="btn btn-light text-success disabled placeholder" type="button"><i class="fas fa-play"></i></button>&nbsp;
            <button class="btn btn-light text-success disabled placeholder" type="button"><i class="fas fa-angle-double-right"></i></button>&nbsp;
            <button class="btn btn-light text-success disabled placeholder" type="button"><i class="fas fa-redo"></i></button>&nbsp;
            <button class="btn btn-light text-success disabled placeholder" type="button"><i class="fas fa-random"></i></button>
          </div>
        </div>
      </div>
    </nav>
